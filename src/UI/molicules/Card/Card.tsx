...
export default function Card({ children, className = '',description='',title='' ,sub_title=''}: CardProps) {
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-linear-to-br from-cyan-500/5 to-transparent rounded-2xl opacity-0 hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
